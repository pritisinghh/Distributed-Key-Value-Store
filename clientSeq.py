import zmq
from constants import PORT, TYPE, SERVER_CNT, START_SERVER_PORT, HOST,PRIMARY_PORT
import random
...
def start_client():
    ...
    # pick a random number between 0 to SERVER_CNT and assign the client to it
    serverPorts=[]
    for i in range(SERVER_CNT):
        serverPorts.append(START_SERVER_PORT+i)
    serverPorts.append(PRIMARY_PORT)

    server_port = random.choice(serverPorts)
